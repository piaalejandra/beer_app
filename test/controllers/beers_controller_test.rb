...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { cost: @beer.cost, description: @beer.description, image: @beer.image, name: @beer.name, style: @beer.style }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { cost: @beer.cost, description: @beer.description, image: @beer.image, name: @beer.name, style: @beer.style }
    assert_redirected_to beer_path(assigns(:beer))
  end
